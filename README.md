...
- **Statistics Explorer**: Precomputed history views — WR progression, record longevity, fastest improving players (7d/30d/90d/365d), contested / stale categories, Unicorns (Lottery + Cheese 50 Small), Legends (Mythic), unheld difficulty rankings, category popularity, and activity heatmaps
...
- Longevity, contested, stale, popularity, unicorns, legends, and unheld list Mode + Count + Speed + Size + Run; Longevity has All-time / Still standing toggles; Unicorns lists ever-held Lottery (plus all Cheese 50 Small) with present holders first; Legends lists ever-held Mythic by difficulty score; Unheld ranks never-held categories by difficulty tier (Free→Inhuman)
